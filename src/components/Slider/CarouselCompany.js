...
import {CarouselItem, CarouselItemCompany} from "./CarouselItem";
...
function Carousel(props,title) {
  ...
  return (
    <section id="carousel">
      <div className="carouselCompany">
        <div className="carousel-leftCompany">
      <div className="titleCompany">Các công ty hàng đầu</div>
          <div className="carousel-left-slide">
            <Slider asNavFor={nav.nav2}
              ...
              {data.map((e,i)=> {
                return (
                  <div key={i} className="carouselItemCompany">
